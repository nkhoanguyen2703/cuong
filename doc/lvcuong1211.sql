...
(1, '2018-11-10 00:00:00', '2019-11-10 00:00:00', 1000, 3000, 10, 0, 'PND12', '2018-11-10 04:22:37', 1, 'adminkho');
...
INSERT INTO `taikhoan` (`id`, `pass`, `ten`, `ngaysinh`, `diachi`, `sdt`, `trinhdo`, `quyen`) VALUES
('admin', '21232f297a57a5a743894a0e4a801fc3', 'Nguyễn Văn Min', '0000-00-00 00:00:00', '', 0, '', 'ADMIN'),
('adminkho', 'e10adc3949ba59abbe56e057f20f883e', 'Nguyễn Văn Kho', '0000-00-00 00:00:00', '', 0, '', 'QUANLYKHO');
...
--
ALTER TABLE `lothuoc`
  MODIFY `lt_solo` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `phieuxuat`
  MODIFY `px_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
